...
class Tetris:
    ...
    def break_lines(self):
        ...
        game.level = 1 + (int(self.score / 100))
        if (game.level) >= 12:
            game.level = 12
...
while not done:
      ...
      for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_F1:
                game.mode = "AI"
            if event.key == pygame.K_q or event.key == pygame.K_UP:
                game.rotate()
    ...
    text = font.render(
        "Score: " + str(game.score) + " - Level: " + str(game.level), True,
        BLACK)
    if game.mode == 'AI':
      temp = "On"
    else:
      temp = "Off"
    text2 = font.render("AI Mode : " + temp + " (F1)", True, BLACK)
    text_game_over = font1.render("Game Over", True, (255, 125, 0))
    text_game_over1 = font1.render("Press ESC", True, (255, 215, 0))
    text_game_over2 = font2.render("Score: " + str(game.score), True,
                                   (255, 185, 0))
    text_game_over3 = font2.render("Highscore: " + str(game.highest_score),
                                   True, (255, 185, 0))
    ...
    if game.state == "gameover":
        ...
        screen.blit(text_game_over3, [25, 380])
